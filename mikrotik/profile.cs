...
namespace mikrotik
{
    ...
    public class PROFILECLASS
    {
        public void help()
        {
            ...
            Console.WriteLine("\t mikrotik profile help");
            Console.WriteLine("\t mikrotik profile list");
            Console.WriteLine("\t mikrotik profile remove <input: name>");
            Console.WriteLine("\t mikrotik profile add <input: name>");
            Console.WriteLine("");
        }

        public void list()
        {
            Terminal.WriteText("::List all profiles in mikrotik", ConsoleColor.Green, Console.BackgroundColor);
